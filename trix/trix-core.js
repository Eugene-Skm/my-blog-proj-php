                    ...
                    if (e.className) 
                        for (l = e.className.split(" "), o = 0, s = l.length; s > o; o++) 
                            ...
                            i
                                .classList
                                .add(n);
                    return e.textContent && (i.textContent = e.textContent),
                    i
                },
                            ...
                            : (
                                (a = n.getData("URL"))
                                    ? (
                                        ...
                                        null != (x = this.responder) && x.insertHTML(l.html),
                                        this.requestRender(),
                                        null != (C = this.delegate) && C.inputControllerDidPaste(l)
                                    )
                                    : i(n)
                                        ? (
                                            l.type = "text/plain",
                                            l.string = n.getData("text/plain"),
                                            null != (S = this.delegate) && S.inputControllerWillPaste(l),
                                            this.setInputSummary({textAdded: l.string, didDelete: this.selectionIsExpanded()}),
                                            null != (R = this.responder) && R.insertString(l.string),
                                            this.requestRender(),
                                            null != (k = this.delegate) && k.inputControllerDidPaste(l)
                                        )
                                        : (u = n.getData("text/html"))
                                            ? (
                                                l.type = "text/html",
                                                l.html = u,
                                                null != (E = this.delegate) && E.inputControllerWillPaste(l),
                                                null != (w = this.responder) && w.insertHTML(l.html),
                                                this.requestRender(),
                                                null != (D = this.delegate) && D.inputControllerDidPaste(l)
                                            )
                                            : m.call(n.types, "Files") >= 0 && (
                                                s = null != (g = n.items) && null != (y = g[0]) && "function" == typeof y.getAsFile
                                                    ? y.getAsFile()
                                                    : void 0
                                            ) && (
            ...
            e.AttachmentEditorController = function (u) {
                ...
                p.prototype.addToolbar = d(function () {
                    ...
                    n.innerHTML = '<div class="trix-button-row">\n  <span class="trix-button-group trix-button-gr' +
                            'oup--actions">\n    <button type="button" data-trix-action="remove" class="tri' +
                            'x-button trix-button--remove" title="' + s.remove + '">' + s.remove + "</butto" +
                            "n>\n  </span>\n</div>",
                    this
                        .attachment
                        .isPreviewable() && (
                            ...
                            n.innerHTML += '<div class="' + t.attachmentMetadataContainer + '">\n  <span class="' + t.attachmentMetadata +
                            '">\n    <span class="' + t.attachmentName + '" title="' + r + '">' + r + '</sp' +
            ...
            e.BlockView = function (r) {
                ...
                s.prototype.createNodes = function () {
                    ...
                    if (
                        ...
                        this.block.isEmpty()
                            ? u.push(i("br"))
                            : (
                                l = null != (c = n(this.block.getLastAttribute()))
                                    ? c.text
                                    : void 0,
                ...
                s.prototype.createContainerElement = function (e) {
                    ...
                    "attachmentGallery" === o && (
                        ...
                        r.className = t.attachmentGallery + " " + t.attachmentGallery + "--" + s
                    ),
                    i(r)
                },
        ...
        function () {
            ...
            e.Block = function (n) {
                ...
                a.prototype.canBeGroupedWith = function (t, e) {
                    ...
                    r = s[e],
                    n = this.attributes[e],
                    n === r && !(i(n).group === !1 && (a = s[e + 1], u.call(o(), a) < 0))
                },
                h = function (t) {
                    return t = v(t),
                    t = l(t)
        ...
        function () {
            ...
            e.HTMLSanitizer = function (r) {
                function u(t, e) {
                    ...
                    null == this.forbiddenProtocols && (this.forbiddenProtocols = l),
                    this.body = h(t)
                }
                var c,
                    l,
                ...
                p = function (e) {
                    return (
                        ...
                        ? void 0
                        : "script" === n(e) || "false" === e.getAttribute("data-trix-serialize")
                },
                h = function (t) {
                    var e,
                        n,
            ...
            e.HTMLParser = function (d) {
                ...
                g.prototype.getTextAttributes = function (t) {
                    ...
                    for (n in d) 
                        ...
                        u.styleProperty && (m = t.style[u.styleProperty]) && (r[n] = m);
                ...
                g.prototype.isInsignificantTextNode = function (t) {
                    ...
                    if ((
                        null != t
                            ? t.nodeType
                            : void 0
                    ) === Node.TEXT_NODE && w(t.data) && (
                        n = t.parentNode,
                        i = t.previousSibling,
                        e = t.nextSibling,
                        (!C(n.previousSibling) || this.isBlockElement(n.previousSibling)) && !y(n)
                    )) 
                ...
                c.prototype.removeTextAtRange = function (t) {
                    ...
                    o(t)
                        ...
                        : (
                            ...
                            f
                                ? r = this.blockList.editObjectAtIndex(y, function (t) {
                                ...
                                : (
                                    ...
                                    C = h.appendText(x),
                                    g = a !== y && 0 === c,
                                    S = g && s.getAttributeLevel() >= m.getAttributeLevel(),
                                    n = S
                                        ? m.copyWithText(C)
                                        : s.copyWithText(C),
                                    e = y + 1 - a,
            ...
            e.LocationMapper = function () {
                ...
                return e.prototype.findLocationFromContainerAndOffset = function (e, i, o) {
                    ...
                    for (
                        ...
                        y = h(this.element, {usingFilter: f}); y.nextNode();
                    ) {
            ...
            e.registerElement("trix-editor", function () {
                ...
                d = function (t) {
                    return t.hasAttribute("contenteditable")
                        ? void 0
                        : (t.setAttribute("contenteditable", ""), o("focus", {
                            onElement: t,
                ...
                h = function (t) {
                    return (
                        ...
                        ? (document.execCommand("enableObjectResizing", !1, !1), i("mscontrolselect", {
                            onElement: t,
                            preventDefault: !0
                        }))
                        : void 0
                ...
                l = function () {
                    ...
                    defaultCSS: "%t {\n  display: block;\n}\n\n%t:empty:not(:focus)::before {\n  content: attr(" +
                            ...
                            "999px;\n  max-height: 0px;\n}\n\n%t " + t + " figcaption[data-trix-placeholder" +
                            "]:empty::before {\n  content: attr(data-trix-placeholder);\n  color: graytext;" +
                            "\n}\n\n%t [data-trix-cursor-target] {\n  display: " + l.display + " !important" +
                            ";\n  width: " + l.width + " !important;\n  padding: 0 !important;\n  margin: 0" +
                            " !important;\n  border: none !important;\n}\n\n%t [data-trix-cursor-target=lef" +
